...
For 1.4, I tried to do Library(tidyverse), and it came up with an error so I thought I'd put in the actual installation but now it can't "pend the execution" and same goes for task two. 

I think I have the data right, though. It just doesn't have an output. 
